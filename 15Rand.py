    ...
    for index in range(iterations):  
        ...
        for i in range(epochs):
            ...
            for individual in Rand_pop:
                ...
                Ind_new.mutation_width = individual.mutation_width*np.exp(0.95*np.random.normal(0, 1))
                Ind_new.marker = 1
...
topology=[2,20,20,1],population=50,survivors=45,width_decay=1,mutation_width=1,dir_decay=0)
