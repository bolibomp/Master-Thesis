    ...
    for index in range(iterations):  
        ...
        for i in range(epochs):
            ...
            for individual in Rand_pop:
                ...
                mutation_width, boost, width_decay, dir_decay, weight_distr, hidden_layer, all_plots,topology)
                Ind_new.positionvector = individual.positionvector + individual.direction + individual.mutation_width*np.random.normal(0, 1, len(individual.positionvector))
                Ind_new.direction = Ind_new.positionvector - individual.positionvector + individual.direction
            ...
            for individual in Rand_pop:
                ...
                if individual.marker == 0:  
                    individual.direction = individual.direction*dir_decay
...
topology=[2,20,20,1],population=50,survivors=30,width_decay=0.8,mutation_width=0.1,dir_decay=0.5)
